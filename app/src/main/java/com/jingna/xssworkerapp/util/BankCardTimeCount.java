...
public class BankCardTimeCount extends CountDownTimer {

    private SpannableString msp = null;
    private int timeNum = 60;
    private InsertBankCardActivity activity;
    ...
    public InsertBankCardActivity getActivity() {
        return activity;
    }

    public void setActivity(InsertBankCardActivity activity) {
        this.activity = activity;
    }

    public BankCardTimeCount(long millisInFuture, long countDownInterval) {
