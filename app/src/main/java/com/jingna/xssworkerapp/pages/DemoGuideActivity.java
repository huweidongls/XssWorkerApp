...
import com.jingna.xssworkerapp.baidu.EventHandler;
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode)
                        bundle.getSerializable(OrderDetailsActivity.ROUTE_PLAN_NODE);
            }
        }
                ...
                public void handleMessage(Message msg) {
                    if (msg.what == MSG_RESET_NODE) {
                        mRouteGuideManager.resetEndNodeInNavi(new BNRoutePlanNode.Builder()
                                ...
                                .coordinateType(BNRoutePlanNode.CoordinateType.GCJ02).build());
                    }
                }
            };
        }
